...
if theta1>theta2
    Logique=theta_donnees_bruitees<theta2 | theta_donnees_bruitees>theta1,
else
    Logique=theta_donnees_bruitees>theta1 & theta_donnees_bruitees<theta2;
end

x_donnees_bruitees=x_donnees_bruitees(Logique);
y_donnees_bruitees=y_donnees_bruitees(Logique);
