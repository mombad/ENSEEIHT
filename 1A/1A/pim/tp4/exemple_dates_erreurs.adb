...
begin
    ...
    --Afficher_Deux_Positions (2);                                  --la procedure afficher_deux_positions n'est pas accessible à l'utilisateur.
    New_Line;
    ...
    --Une_Date.jour := 15;                                          -- le type T_date est privé donc on ne peut pas modifier directement
