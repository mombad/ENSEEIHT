...
explication_x1 = subplot(2,2,2);
text(0,0.5,'=> Je suis un homme à lunettes, mes équations donnent mal à la tête'); axis off
explication_x2 = subplot(2,2,4);
text(0,0.5,'=> Je pourrais presque être une loi mais ne suis pas une girafe ...'); axis off
